...
abstract class BasePartidoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'equipo_local_id'     => new sfWidgetFormInputText(),
      'equipo_visitante_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Equipo_Partido'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'equipo_local_id'     => new sfValidatorPass(),
      'equipo_visitante_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Equipo_Partido'))),
