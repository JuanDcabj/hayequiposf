...
/**
 * Multimedia_Video form base class.
 *
 * @method Multimedia_Video getObject() Returns the current form's model object
 *
 * @package    hayequiposf
 * @subpackage form
 ...
 */
abstract class BaseMultimedia_VideoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'video'          => new sfValidatorString(array('max_length' => 30)),
      'pie'            => new sfValidatorString(array('max_length' => 250, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('multimedia_video[%s]');
